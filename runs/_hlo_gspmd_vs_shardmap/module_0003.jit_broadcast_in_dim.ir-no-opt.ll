...
define amdgpu_kernel void @wrapped_broadcast(ptr noalias align 16 dereferenceable(2) %0, ptr noalias align 256 dereferenceable(33554432) %1) #0 {
  ...
  %12 = getelementptr inbounds [16777216 x bfloat], ptr %1, i32 0, i32 %9
...
attributes #0 = { "amdgpu-flat-work-group-size"="256,256" "amdgpu-max-num-workgroups"="16384,1,1" "uniform-work-group-size"="true" }
