---
layout: distill
title: "The JAX Software Stack on ROCm"
...
![]({{ '/pages/img/hlo_to_thunks.svg' | relative_url }})

2. XLA lowers an HLO operation through an XLA GPU emitter, Triton, or an integrated
runtime library.

![]({{ '/pages/img/hlo-3-path-lower.png' | relative_url }})
...
![]({{ '/pages/img/hlo-3-path-lower-detailed.svg' | relative_url }})
...
[![XLA-rendered HLO subgraph for standard JAX attention]({{ '/pages/img/hlo-attention-xla.svg' | relative_url }})]({{ '/pages/img/hlo-attention-xla.svg' | relative_url }})
...
[![XLA-rendered HLO subgraph for Transformer Engine fused attention]({{ '/pages/img/hlo-attention-te.svg' | relative_url }})]({{ '/pages/img/hlo-attention-te.svg' | relative_url }})
